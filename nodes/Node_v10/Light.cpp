...
void Light::setBrightness(byte bright) {
  if( bright > 0 ) {
...
void Light::pacifica_one_layer( CRGBPalette16& p, uint16_t cistart, uint16_t wavescale, uint8_t bri, uint16_t ioff)
{
  uint16_t ci = cistart;
...
void Light::pacifica_add_whitecaps()
{
