...
void setup() {
  ...
  espNowFloodingMesh_begin(ESP_NOW_CHANNEL, ESP_NOW_BSSID);
  espNowFloodingMesh_secredkey(secredKey);
//  espNowFloodingMesh_setToBatteryNode();

  Serial.println("Minion begin() complete");
}
...
void loop() {
  ...
  espNowFloodingMesh_syncTimeAndWait();
